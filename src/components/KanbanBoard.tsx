...
// Usa drag-and-drop nativo do HTML5 (sem dependências externas).
// ============================================================================
...
export function KanbanBoard({ leads, onAbrir, onMudarStatus }: Props) {
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-2 px-2 pb-3">
              {cards.length === 0 && (
                <div className="rounded-md border border-dashed border-slate-300 py-6 text-center text-xs text-slate-400">
              ...
              {cards.map((lead) => (
                <div
                  ...
                  className={`cursor-grab rounded-md bg-white p-3 shadow-sm ring-1 ring-slate-200 transition hover:shadow active:cursor-grabbing ${
                ...
                >
                  ...
                  {lead.cidade && (
                    <p className="mt-1 text-xs text-slate-400">{lead.cidade}</p>
                  )}
                  {lead.tags.length > 0 && (
